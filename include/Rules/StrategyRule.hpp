...
IWMEArray StrategyRule<FinalLogicRule, Other...>::operator() (const IWMEArray &lhs)
{
...
template <class FinalLogicRule, class ...Other>
IWMEArray StrategyRule<FinalLogicRule, Other...>::operator() (const IWMEArray &lhs, const SpecificRuleBindedData &bindedParam)
{
